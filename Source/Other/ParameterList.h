...
static juce::String MyParameterID [Parameter_TotalNumParameters] =
{
    "InputGain",
    "Time",
    "TimeSliderType",
...
static juce::String ParameterLabel [Parameter_TotalNumParameters] =
{
    "Input",
    "Time",
    "ChangeMode",
...
static juce::String NoteTypeLabel [NoteType_TotalNumNoteTypes] =
{
    "1/16 Triplet",
    "1/32 Dotted",
    "1/16",
